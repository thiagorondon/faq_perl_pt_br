...
utilizam recursos da linguagem para tornar seu código mais legível, como o
...
(JRM) (21/10/2011) Expressões regulares são muito utilizadas para realizar captura de vários dados
...
(JRM) (21/10/2011) As expressões regulares são implementadas na maioria das linguagens de
programação, o que facilita muito ao buscar algo pronto em sites pela internet a fora.
O módulo L<Regexp::Common|http://search.cpan.org/perldoc?Regexp::Common>. no CPAN oferece muitas alternativas prontas de expressões regulares.
